...
GoogleSpreadSheetのGASとかMicrosoftOfficeのVBAでちょっとしたアプリを作るとかLambdaの関数を1本書くぐらいの規模であれば、ウォーターフォールで計画してもうまくいくでしょう(*2)。
...
大きなプロダクトで必要とあれば、いきなりは難しいかもしれません。

今後纏めてみようとおもうのですが、outputからoutcomeへのプロダクトの目的の違い(5回目に詳しく)、クロスファンクショナルチームが必要(6回目に詳しく)だったり、チームとして活動していくことや（3回目に詳しく）、チームとして学習(4回目に詳しく)が必要だったりとウォーターフォールがメインだったころとは違う組織文化を作っていく必要があります。

ここができずに大きなプロダクトで適用することはとてもリスクが高いものになります。

なので、トップダウンからのアプローチとしては、まず小さなプロダクトから、ボトムアップのアプローチとしては８回目で詳しく纏めてみる「チェンジマネジメント」のアプローチから始めるのが良さそうです。

大きなプロダクトでアジャイルが適用できるとなれば、Scrumの規模(1チーム)でもできますし、LessやSAFe、Scrum＠Scaleなどいくつかの大規模アジャイル用のフレームワークがあったりします。(参考：[大規模アジャイルフレームワークの紹介](https://www.ryuzee.com/contents/blog/14563))

(大規模アジャイル用のフレームワークはあったりしますが、ウォーターフォールで30人規模のプロジェクトぐらいであれば、アジャイルのアプローチで１チーム7,8人+αで進められる可能性はあると思います。筋肉質な組織をつくるという意味でもアジャイルのアプローチが有効かもしれません。)
...
※1 ウォーターフォールというプロセスと比較するうえで「アジャイル」というのはやや広義すぎる感じもします。とはいえフレームワークであるScrumの話はほとんどする予定がないため「アジャイル」という言葉を使用していきます。ウォーターフォールを適用する組織、チームとアジャイルな組織、チームぐらいの感覚で読んでいただくといいかもしれません。
※2 ウォーターフォールは意味がないという話もありますが、基本的には同じ立場です。とはいえ、1週間未満で終わるような、作るだけでよいものなどは作ってしまったほうが早いというぐらいの感覚です（大方そんな小さすぎる規模のものを指してウォーターフォールやらアジャイルやらの議論はしないだろうなという感じであります）