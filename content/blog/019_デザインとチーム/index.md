---
title: "なぜアジャイルなのか⑦ デザインとチーム、VISION/MISSION・まとめとしてのモダンアジャイル"
date: 2024-07-22T13:07:47+09:00
draft: false
...
# meta description
description: "いまさらかもしれないですが、そんなしなくてもいい苦労をしているチームに向けて「なぜアジャイル・Scrumなのか？」ということと「アジャイルとは何か？」ということについていくつかの記事にわけてまとめてみるシリーズ7回目です。7回目のテーマは「デザイン」です"
...
- 第六回：{{< link-corss-ref "/blog/018_クロスファンクショナルチーム/index.md" >}}
...
よくプロダクトにはVISIONとMISSIONが必要だと言われますが、理由はこういうことです。チームメンバーは常にVISION・MISSIONを意識しながらプロダクトを進めていく必要があります。
...
非常に難しいですけどね。（以下は[デザインリサーチの教科書](https://www.amazon.co.jp/dp/B08MZQ9X1B)の著者である木浦さんのXの投稿です）

https://x.com/kur/status/1815417380941767130

```
デザインリサーチ x アジャイル開発、
絶対に必要なんだけど「これならうまくいく」
みたいな方法がいまだに存在しないのでめちゃくちゃ探索しがいがあると思う。
```
...
- 群盲像を評す状態からメンバーの景色を見るには学習・対話・心理的安全性といった「チームを作る」といったことが必要で、タックマンモデルを参考にしながらのManagement3.0はそれらに対処する手段として有効(4回目)
...
アジャイルとScrumを重ね合わせるとこんな感じです。

![agile](./agileとは.jpg)

# モダンアジャイル

最後に、[モダンアジャイル](https://modernagile.org/)を紹介します。

![モダンアジャイル](./modern_agile.png)

この4つは基本原則であり、[アジャイルソフトウェア開発宣言](https://agilemanifesto.org/iso/ja/manifesto.html)のように具体的にこうするべきということは書いていません。フレームワークやプラクティスも定義されておらず、チーム、組織それぞれで考えましょうということです。

４つの原則を見ると、
- 人々を最高に輝かせる(Make People Awesome) 
- 継続的に価値を届ける(Deliver value Continuously)
- 安全を必須条件にする(Make Safety a Prerequisite)
- 高速に実験＆学習をする(Experiment ＆ Lean Rapidly)
...
安全とは？
何を実験？学習？
といったことをチームで考えられるといいと思います。それぞれこれまでの内容が原則にもピッタリはまるので参考になるでしょう。


さてさて、これらを全部実現しようとすると、組織ごと変えなければいけないことに気がつくでしょう。トップダウンでできれば苦労なく、こんなブログもいらないのですが、そうはいかないことのほうが多いでしょう。
